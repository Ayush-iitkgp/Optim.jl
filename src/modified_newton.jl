immutable ModifiedNewton <: Optimizer
    linesearch!::Function
end

ModifiedNewton(; linesearch!::Function = hz_linesearch!) =
  ModifiedNewton(linesearch!)

function optimize(d::Function,
                  initial_x::Array,
                  method::ModifiedNewton,
                  options::OptimizationOptions)
    throw(ArgumentError("Modified Newton's method without a user supplied gradient and hessian is currently not supported."))
end
